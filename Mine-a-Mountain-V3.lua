--[[
Mine a Mountain - Main Script

ไฟล์นี้เป็นสคริปต์หลักที่โหลด GUI ผ่านเว็บจาก GUI_URL
ถ้าต้องเปลี่ยนเว็บ ให้แก้ลิงก์ตรงตัวแปร GUI_URL ด้านล่าง
]]
...
DropRequest = findRemote("DropRequest") or findRemote("DiscardRequest") or findRemote("DeleteCrystalRequest")
...
function NewAutoFarm.discardCrystalTool(tool)
	...
	if pressed then
		task.wait(0.2)
		return not tool.Parent or tool.Parent == Workspace
	end
	...
	Library:Notify("Drop failed: Backspace simulation unavailable", 3)
	return false
end
