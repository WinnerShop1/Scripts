...
local function crystalTier(inst)
	local owner = crystalAttrOwner(inst) or inst
	return tonumber(getAttr(owner, "Tier")) or 0
end
...
เพิ่มไว้ท้ายไฟล์ตามที่ขอ
ฟังก์ชันนี้แค่ประกาศไว้ให้เรียกใช้ ยังไม่ได้แทนระบบ teleport เดิมอัตโนมัติ
ถ้าจะใช้ ให้เรียก safeTweenTeleport(CFrame.new(...)) หรือเอาไปเชื่อมกับ teleportTo ภายหลัง
]]
