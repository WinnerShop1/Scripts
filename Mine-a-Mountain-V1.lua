...
--[[
Custom GUI Adapter - เชื่อม GUI ตัวใหม่เข้ากับฟังก์ชันเดิม

ส่วนนี้แทน Obsidian UI Library เดิมด้วย GUI ที่สร้างจาก Roblox Instance โดยตรง
เป้าหมายคือให้โค้ดเดิมด้านล่างยังใช้คำสั่งเดิมได้ เช่น:
- Library:CreateWindow()
- Window:AddTab()
- Tab:AddLeftGroupbox() / AddRightGroupbox()
- Groupbox:AddToggle(), AddSlider(), AddInput(), AddButton(), AddDropdown(), AddLabel()
- Library:Notify(), Library:Unload(), Library:OnUnload()
- SaveManager / ThemeManager แบบเบื้องต้น

หมายเหตุ:
- ฟังก์ชัน gameplay เดิมยังอยู่ด้านล่างเหมือนเดิม
- เปลี่ยนเฉพาะชั้น GUI/SaveManager/ThemeManager เพื่อไม่ต้องโหลด Library จาก GitHub
]]

local function createStudioGuiLibrary()
...
local Library, SaveManager, ThemeManager = createStudioGuiLibrary()
